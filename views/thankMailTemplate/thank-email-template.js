                      ...
                      <tr>
                        <td align="center" class="social-icon" style="padding: 0 15px;">
                          <a href="#" style="display: inline-block;">
                            <img src="cid:linkedin@npatel" alt="LinkedIn" width="24" height="24" style="display: block;" />
                          </a>
                        </td>
                        <td align="center" class="social-icon" style="padding: 0 15px;">
                          <a href="#" style="display: inline-block;">
                            <img src="cid:instagram@npatel" alt="Instagram" width="24" height="24" style="display: block;" />
                          </a>
                        </td>
                        <td align="center" class="social-icon" style="padding: 0 15px;">
                          <a href="#" style="display: inline-block;">
                            <img src="cid:envelope@npatel" alt="Email" width="24" height="24" style="display: block;" />
                          </a>
                        </td>
                      </tr>
                    </table>
